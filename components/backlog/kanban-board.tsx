  ...
  const [columns, setColumns] = useState<Column[]>([
    {
      ...
      title: "À Faire",
      tasks: [
        { id: "1", title: "Refonte page d'accueil", priority: "high", points: 8 },
        { id: "2", title: "Optimisation performances", priority: "medium", points: 5 },
      ]
    },
    {
      id: "inProgress",
      title: "En Cours",
      tasks: [
        { id: "3", title: "Tests A/B tunnel de conversion", priority: "high", points: 13 },
      ]
    },
    {
      id: "done",
      title: "Terminé",
      tasks: [
        { id: "4", title: "Analyse des besoins utilisateurs", priority: "high", points: 5 },
      ]
    }
  ])
